...
const About = () => {
    ...
    <section id="aboutMe">
        <p>
            ...
            the
            oil field
            industry. The company I work for is based out of Oklahoma City and we provide many forms of
            communication
            to companies out in the oil field. I have two beautiful and amazing children and to top it
            off
            an
            equally
            amazing and beautiful wife.
        </p>
        <p>
            I am also currently a part-time student at UTSA and I am studying on becoming a web
            developer.
            My
            drive in
